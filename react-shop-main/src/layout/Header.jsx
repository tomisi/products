  ...
  return (
    <nav className="py-4 px-5 md:px-24  lg:px-40 relative w-full border-b border-grayshade-300">
      ...
      <div className="w-full z-99 flex items-center justify-between">
        <Link to={"/products"}>
          <h1 className="lg:text-5xl md:text-4xl text-xl font-semibold">Product Cluster</h1>
        </Link>
        <div className="flex items-center justify-between">
          ...
          <ThemeSwitcher />
          <Link className="lg:mx-6 md:mx-4 mx-3" to={'https://github.com/tomisi'} target="_blank">
